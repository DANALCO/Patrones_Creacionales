...
public class Employee {
    ...
    public static class EmployeeBuilder  implements IBuilder{
        ...
        public EmployeeBuilder setPhone(String phoneNumber, String phoneType){
            this.phones.add(new Phone(phoneNumber, phoneType));
            return this;
        }
        ...
        public void SetAddress(String address, String city , String country, String cp) {
        }
    }
